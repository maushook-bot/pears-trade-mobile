...
class _AuthScreenState extends State<AuthScreen>
      ...
      body: Stack(
        children: [
          ...
          Container(
            ...
            child: _buildAuthCard(deviceSize),
          ),
        ],
      ),
  ...
  Widget _buildAuthCard(Size deviceSize) {
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                icon: Icon(Icons.email_outlined, color: Colors.green.shade900),
                labelStyle: TextStyle(color: Colors.grey.shade400),
                hintStyle:
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                icon: Icon(Icons.lock_outlined, color: Colors.green.shade900),
              ...
              child: FadeTransition(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    icon:
                        Icon(Icons.lock_outlined, color: Colors.green.shade900),
                    labelStyle: TextStyle(color: Colors.grey.shade400),
                    helperStyle: TextStyle(color: Colors.grey.shade400),
                    hintStyle: TextStyle(
